...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):#k-means聚类方法定anchor
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Arguments:
            ...
            thr: anchor-label wh ratio threshold hyperparameter hyp['anchor_t'] used for training, default=4.0；与anchor_t相同
